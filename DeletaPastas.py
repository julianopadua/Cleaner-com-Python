...
class RankingPastasApp:
    ...
    def bytes_para_gb(self, tamanho_em_bytes):
        return tamanho_em_bytes / (1024 ** 3)  # Convertendo bytes para gigabytes

    def rank_top5_pasta_por_tamanho(self, caminho_pasta):
        pastas = []

        # Lista todas as pastas dentro do caminho fornecido
